...
class ZhihuAccount(object):
    ...
    def __init__(self, captcha_lang='en', ua=None):
        ...
        self.session.headers = {
            ...
            'User-Agent': ua or 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 '
                                '(KHTML, like Gecko) Chrome/68.0.3440.84 Mobile Safari/537.36'
        }
...
if __name__ == '__main__':
    ...
    account.login(username='13760710096', password='XQY1197966810G', load_cookies=True)